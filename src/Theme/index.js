...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#2ead9d' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#2ead9d',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#2ead9d',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#2ead9d',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #2ead9d30 0%, #fff 0%)`,
})
